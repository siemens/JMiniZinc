...
public class IntegerVariable extends Variable<Integer, Integer> implements IntegerExpression {
  ...
  @Override
  public IntegerVariable substitute(String name, Object value) {
    return new IntegerVariable(this.getName(), this.type.substitute(name, value), this.value.substitute(name, value));
  }
